...
classifier = cv2.CascadeClassifier('C:/Users/swaya/OneDrive/Desktop/Face dection/Face dection/haarcascade_frontalface_default.xml')

model = load_model("final_model(1).h5")

URL = 'http://100.111.111.84:8080/shot.jpg'
